...
<div class="row container">
        ...
        <table class="striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input style="width: 40px; font-weight:900; " class="white center" min="1" name="quantity" type="number" value="{{ $item->quantity }}"></td>
                    <td>
    ...
    <div class="row container center">
        ...
        <button class="btn waves-effect waves-light green"> Finalizar pedido <i class="material-icons right">check</i></a>
    </div>
